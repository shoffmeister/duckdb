...
from typing import overload, Dict, List, Tuple, Union
import pandas
...
class DuckDBPyConnection:
    ...
    def fetchnumpy(self) -> Dict[Any, Any]: ...
    ...
    def torch(self) -> Dict[Any, Any] ...
    def tf(self) -> Dict[Any, Any]: ...
...
class DuckDBPyRelation:
    ...
    def torch(self, connection: DuckDBPyConnection = ...) -> Dict[Any, Any]: ...
    def tf(self, connection: DuckDBPyConnection = ...) -> Dict[Any, Any]: ...
    ...
    def write_parquet(
            ...
            file_name: str,
            compression: Optional[str] = None,
            field_ids: Optional[Dict[Any, Any] | str] = None,
...
# stubgen override - usage of dict causes typing warnings; use a typed equivalent
def connect(database: Union[str, Path] = ..., read_only: bool = ..., config: Dict[Any, Any] = ...) -> DuckDBPyConnection: ...
...
def fetchnumpy(*, connection: DuckDBPyConnection = ...) -> Dict[Any, Any]: ...
...
def torch(*, connection: DuckDBPyConnection = ...) -> Dict[Any, Any]: ...
def tf(*, connection: DuckDBPyConnection = ...) -> Dict[Any, Any]: ...
